...
public class ControlSkinPrototype extends SkinBase<ControlBarras> {
    ...
    public ControlSkinPrototype(ControlBarras control) {
        super(control);
        initLinesAndValues();
    ...
    private void initGraphics(ControlBarras control) {
